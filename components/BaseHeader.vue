      ...
      <div class="outer">
        <div class="px-layout px-5">
          <div class="inner flex justify-between items-center">
            <div class="logo grow flex items-center relative gap-5">
              <div class="logo__slogan">MAKING GREAT THINGS — [NEROK]</div>
              <NuxtLink to="https://ac3-studio.com" target="_blank">
                <svg
                  width="102"
                  height="34"
                  viewBox="0 0 102 34"
              ...
              <div
                class="logo__qr overflow-hidden absolute top-[2rem] left-[-3px]"
              >
                <NuxtLink to="/">
                  <img
                    src="/svg/PortfolioQR02.svg"
...
<style>
.logo__qr {
  max-width: 60px; /* Establece un ancho máximo para el div */
  min-width: 0; /* Asegura que el div pueda reducir su ancho si es necesario */
  overflow: hidden;
}
